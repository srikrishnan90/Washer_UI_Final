...
{
    QMovie *movie = new QMovie("/home/pi/support/loader.gif");
...
void MainWindow::on_toolButton_28_clicked()
{
    ...
    ui->toolButton_17->setDisabled(true);
    ui->toolButton_28->setDisabled(true);
    qApp->processEvents();
    Pi2c arduino(7);
    QString data="mhm";
    char* ch;
    ...
    if(strncmp(receive,"caldone",7)==0)
    {
        ...
        QStringList list;
        list=str.split(" ");
        ui->lineEdit_14->setText(list[1]);
        save(6,ui->lineEdit_14->text());
    }
